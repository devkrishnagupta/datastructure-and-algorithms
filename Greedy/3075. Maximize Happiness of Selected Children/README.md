...
## Medium
<div class="content__u3I1 question-content__JfgR"><div><p>You are given an array <code>happiness</code> of length <code>n</code>, and a <strong>positive</strong> integer <code>k</code>.</p>
